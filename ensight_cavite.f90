SUBROUTINE write_result_ensight(xEnsight,yEnsight,u,v,omega,div,press,nx,ny,nz,istep,isto,nstep)
   ...
   character(len=80) :: caseName,speedName,omegaName,presName,divName
