subroutine test_conv(u_cent, v_cent, nx,ny, dnormeinfu, dnormeinfv, dnorme2u, dnorme2v,  dnorme1u, dnorme1v,dkinetic, epsi,it_conv)
	implicit none
	
	integer, intent(in) :: nx,ny, epsi
	...
	real*8, dimension(7), intent(out) :: it_conv
